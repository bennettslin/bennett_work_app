export default [
    ...
    {
        taskName: `Continue annotation carousel.`,
        workedHours: 8,
    },
    {
    ...
    {
        taskName: `Finish verse audio button refactor, for now.`,
        workedHours: 2,
    },
    {
        taskName: `Begin work on slider refactor.`,
        workedHours: 8,
    },
    {
        taskName: `Players render one at a time.`,
        workedHours: 3,
    },
    {
    ...
    {
        taskName: `Finish storyboard for Pchelka.`,
        workedHours: 2,
    },
    {
        taskName: `Begin storyboard for Odin.`,
        workedHours: 3,
    },
    {
        taskName: `Clean up Jacob and Howie in Epilogue.`,
        workedHours: 1,
    },
    {
        taskName: `Clean up Khari in Epilogue.`,
        workedHours: 1,
    },
    {
        taskName: `Finish storyboard for Odin.`,
        workedHours: 7,
    },
    {
    ...
    {
        taskName: `Stage section aspect ratio`,
        workedHours: 3,
    },
    {
    ...
    {
        taskName: `Refactoring work of stage tiles and wood.`,
        workedHours: 4,
    },
    {
    ...
    {
        taskName: `Finish work to have just one audio.`,
        workedHours: 6,
    },
    {
    ...
    {
        taskName: `Willy the Cocoa subVerse is not right colour? This is because isSubVerse is no longer passed recursively.`,
        workedHours: 1,
    },
    {
    ...
    {
        taskName: `Another weekend of refactoring.`,
        workedHours: 16,
    },
    {
    ...
    {
        taskName: `Have selectTimeAndVerse return an index so that scrolling can all be handled by EventContainer. (Just got rid of extraneous parameters, which I think is good enough.)`,
        workedHours: 1,
    },
    {
    ...
    {
        taskName: `Stanza and verse Hocs.`,
        workedHours: 5,
    },
    {
    ...
    {
        taskName: `Arrange actor presences by scene.`,
        workedHours: 12,
    },
    {
        taskName: `Arrange thing presences by scene.`,
        workedHours: 2,
    },
    {
    ...
    {
        taskName: `No carousel in low processor. When doing this, create a single flag for whether to mount, and also add similar flags for score and slider.`,
        workedHours: 7,
    },
    {
    ...
    {
        taskName: `Make all tab shadows a pseudo element.`,
        workedHours: 2,
    },
    {
    ...
    {
        taskName: `Make bubbles translucent.`,
        workedHours: 4,
    },
    {
